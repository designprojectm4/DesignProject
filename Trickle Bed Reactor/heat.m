...
OrganicCap=Cal2Joule(OrganicCap);

WaterCap=[1.6702	6.00E-04	3.00E-08	-4.00E-11	4.00E-15];
Tcap2=[1;T;T^2;T^3;T^4];
WaterCap=WaterCap*Tcap2;
HCap=[13.759	0.0008	7.00E-07	-2.00E-10	2.00E-14];
HCap=HCap*Tcap2;
C=vertcat(HCap,OrganicCap(1:3),WaterCap,OrganicCap(4));
%C=[CH;CG;CA;CP;CW;CPOH]
%[FH;FG;FA;FP;FW;FPOH]
mol_frac=Fvec/sum(Fvec);
...
H_form=Formations*T_form;%kH(Cal/mol
...
U=0;%2100;%4e6;%Overall Heat Transfer Coefficient
transferred_heat=U*da*(Tvec(1)-Tvec(2));
dT=(reaction_heat-transferred_heat)/(sum(Fvec)*C_ave);%Change in temperature

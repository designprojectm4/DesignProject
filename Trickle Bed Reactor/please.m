...
%--------------------------------------------------------------------------
%Flow Rates
[dFA,dF] = dF_rk4(Fvec,dW,T,P,d_P,CSA,voidage,cat_density);
Fvec_new=Fvec+dF;
Fvec=Fvec_new;
...
plot(W_array(1:n),FG_array(1:n),W_array(1:n),FA_array(1:n),W_array(1:n),FP_array(1:n),W_array(1:n),FW_array(1:n),W_array(1:n),FPOH_array(1:n))%,W_array(1:n),FH_array(1:n))
plot(W_array(1:n),X_array(1:n))
plot(W_array(1:n),T_array(1:n));
plot(W_array(1:n),PH_array(1:n),W_array(1:n),P_L_array(1:n));
T_max=max(T_array)
T_min=min(T_array)